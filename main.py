...
print("Press \n '1' for checking a single Audio \n '2' for recording and checking audio \n '0' for testing a complete set of audio with Accuracy?")
...
if take == 1:
    ...
    write('Testing_Audio\\output.wav', fs, myrecording)
    path = "output.wav"
    print (("Testing Audio : ",path))
    sr,audio = read(source + path)
    vector   = extract_features(audio,sr)
